...
public class MenuView
{
	 ...
	 * Displays options grouped by entity type (Guest, Room, Expense, Trip).
	 */
	public static void printMainMenu()
	{
		...
		Console.print("--- TRIP ---");
		Console.print("26 - Inserire nuovo viaggio (INSERTTRIPFROMCONSOLE)");
		Console.print("27 - Lista tutti i viaggi (TRIPLIST)");
		Console.print("28 - Cerca viaggio per ID (FINDTRIPBYID)");
		Console.print("29 - Cerca viaggi per città (FINDTRIPSBYCITY)");
		Console.print("30 - Cerca viaggi per anno (FINDTRIPSBYYEAR)");
		Console.print("31 - Elimina viaggio (DELETETRIP)");

		Console.print("--- DATABASE ---");
		Console.print("32 - Crea tabella Guest (CREATETABLEGUEST)");
		Console.print("33 - Crea tabella Room (CREATETABLEROOM)");
		Console.print("34 - Crea tabella Expense (CREATETABLEEXPENSE)");
		Console.print("35 - Crea tabella Trip (CREATETABLETRIP)");
