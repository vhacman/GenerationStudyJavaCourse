package com.generation.pcw.util;
...
public class Console 
{
	...
	/**
	 * Questo metodo (sottoprogramma) aspetta che l'utente inserisca un numero long e prema invio.
	 * @return Il numero long inserito dall'utente
	 * @throws NumberFormatException se il valore inserito non è un numero long valido
	 */
